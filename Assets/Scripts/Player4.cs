...
public class Player4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lifeText = GameObject.Find("LifePlayer4").GetComponentInChildren<Text>();
        ammoText = GameObject.Find("AmmoPlayer4").GetComponentInChildren<Text>();
        ...
        player3 = GameObject.Find("Player4");
    ...
    void Update()
    {
        ...
        if (seconds > 0.3f)
        {
            if ((Input.GetAxisRaw("X360_RightTrigger04")) < 0)
            {
                Shoot();
                timeRemaining = 0;
            }
    ...
    void CallAim()
    {
        if (Input.GetAxisRaw("X360_RStickX04") < 0)
        {
        ...
        if (Input.GetAxisRaw("X360_RStickY04") < 0)
        {
    ...
    void Move()
    {
        var movimento = new Vector3(Input.GetAxisRaw("X360_LStickX04"), Input.GetAxisRaw("X360_LStickY04"), 0);
